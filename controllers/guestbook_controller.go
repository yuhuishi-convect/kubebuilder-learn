...
// +kubebuilder:rbac:groups=webapp.convect.ai,resources=guestbooks,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.convect.ai,resources=guestbooks/status,verbs=get;update;patch
...
// Reconcile the guestbook request
...
// SetupWithManager the manager with fields
