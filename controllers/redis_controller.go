...
// +kubebuilder:rbac:groups=webapp.convect.ai,resources=redis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.convect.ai,resources=redis/status,verbs=get;update;patch

// Reconcile method reconcile the redis object
...
// SetupWithManager sets the fields for the redis
